...
async function runIntegrationTests() {
    ...
    try {
        ...
        assert(loginRes.status === 200 &&
            ...
            !!loginData.data.refreshToken, 'Valid login returns both accessToken and refreshToken');
        ...
        assert(refreshRes.status === 200 &&
            refreshData.success &&
            !!refreshData.data.accessToken &&
            !!refreshData.data.refreshToken, 'POST /auth/refresh returns new accessToken and new refreshToken');
        ...
        const reLoginAdminData = (await reLoginAdmin.json());
