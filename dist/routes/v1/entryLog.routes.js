...
router.get('/:id', auth_middleware_1.authenticate, (0, authorize_middleware_1.requireRole)('guard', 'committee', 'provider_admin'), (0, validateObjectId_middleware_1.validateObjectId)('id'), entryLog_controller_1.getEntryLogById);
...
router.patch('/:id/exit', auth_middleware_1.authenticate, (0, authorize_middleware_1.requireRole)('guard'), (0, validateObjectId_middleware_1.validateObjectId)('id'), entryLog_controller_1.markEntryExit);
