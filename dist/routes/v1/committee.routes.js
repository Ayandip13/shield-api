...
router.get('/:id', auth_middleware_1.authenticate, (0, authorize_middleware_1.requireRole)('provider_admin'), (0, validateObjectId_middleware_1.validateObjectId)('id'), committee_controller_1.getCommitteeMemberById);
router.patch('/:id', auth_middleware_1.authenticate, (0, authorize_middleware_1.requireRole)('provider_admin'), (0, validateObjectId_middleware_1.validateObjectId)('id'), committee_controller_1.updateCommitteeMember);
router.patch('/:id/status', auth_middleware_1.authenticate, (0, authorize_middleware_1.requireRole)('provider_admin'), (0, validateObjectId_middleware_1.validateObjectId)('id'), committee_controller_1.updateCommitteeStatus);
