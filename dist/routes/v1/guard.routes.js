...
router.use('/:guardId/shift', (0, validateObjectId_middleware_1.validateObjectId)('guardId'), shift_routes_1.default);
...
router.get('/:id', auth_middleware_1.authenticate, (0, authorize_middleware_1.requireRole)('provider_admin'), (0, validateObjectId_middleware_1.validateObjectId)('id'), guard_controller_1.getGuardById);
router.patch('/:id', auth_middleware_1.authenticate, (0, authorize_middleware_1.requireRole)('provider_admin'), (0, validateObjectId_middleware_1.validateObjectId)('id'), guard_controller_1.updateGuard);
router.patch('/:id/status', auth_middleware_1.authenticate, (0, authorize_middleware_1.requireRole)('provider_admin'), (0, validateObjectId_middleware_1.validateObjectId)('id'), guard_controller_1.updateGuardStatus);
